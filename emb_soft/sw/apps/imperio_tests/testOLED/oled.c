...
{	
	...
	gpio_direction_set(24, GPIO_MODE_OUT_PP);
	gpio_direction_set(25, GPIO_MODE_OUT_PP);
	gpio_direction_set(26, GPIO_MODE_OUT_PP);
	gpio_direction_set(27, GPIO_MODE_OUT_PP);
	gpio_direction_set(28, GPIO_MODE_OUT_PP);

	for (i=1; i<6; i++)
	{
	printf("i2c%d test begin\n", i);
	if (i==1)
	{
		I2Cx = (i2c_dev_t *)I2C1;
		gpio_set_pin_value(24, 1);
		gpio_set_pin_value(25, 0);
		gpio_set_pin_value(26, 0);
		gpio_set_pin_value(27, 0);
		gpio_set_pin_value(28, 0);
	}
	if (i==2)
	{
		I2Cx = (i2c_dev_t *)I2C2;
		gpio_set_pin_value(24, 0);
		gpio_set_pin_value(25, 1);
		gpio_set_pin_value(26, 0);
		gpio_set_pin_value(27, 0);
		gpio_set_pin_value(28, 0);
	}
	...
	{		
		...
		OLED_ShowCHinese(108,0,6);//��
		if (i==1)
		OLED_ShowString(6,3,"0.96' OLED 1111",16);
		if (i==2)
		OLED_ShowString(6,3,"0.96' OLED 2222",16);
		if (i==3)
		OLED_ShowString(6,3,"0.96' OLED 3333",16);
		if (i==4)
		OLED_ShowString(6,3,"0.96' OLED 4444",16);
		if (i==5)
		OLED_ShowString(6,3,"0.96' OLED 5555",16);
