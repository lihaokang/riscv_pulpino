...
# elaborate design
set hdlin_generate_separator_style "/"
...
set clk_div2_net   peripherals_i/apb_scu/cmu_u0/clk_hs_divider/clk_cnt_reg_0_/Q
set clk_div4_net   peripherals_i/apb_scu/cmu_u0/clk_hs_divider/clk_cnt_reg_1_/Q
set clk_div8_net   peripherals_i/apb_scu/cmu_u0/clk_hs_divider/clk_cnt_reg_2_/Q
set clk_div16_net  peripherals_i/apb_scu/cmu_u0/clk_hs_divider/clk_cnt_reg_3_/Q
set clk_div32_net  peripherals_i/apb_scu/cmu_u0/clk_hs_divider/clk_cnt_reg_4_/Q
set clk_sys_net    peripherals_i/apb_scu/cmu_u0/clk_sys_switch2_0/clk_gate_u0/LAGCE_CLK_O/GCK
set clk_adc_net    peripherals_i/apb_scu/cmu_u0/adc_sys_switch2_0/clk_gate_u0/LAGCE_CLK_O/GCK
set clk_ls_net     peripherals_i/apb_scu/cmu_u0/clk_ls_switch/clk_gate_u0/LAGCE_CLK_O/GCK
...
create_generated_clock -divide_by 1  -name clk_sys1 -source [get_pins analog_top/RING32M_CLK] -master_clock clk_rc32m [get_pins ${clk_sys_net}]
...
create_generated_clock -divide_by 1  -name clk_sys7 -source [get_pins analog_top/RING32K_CLK] -master_clock clk_rc32k [get_pins ${clk_sys_net}] -add
create_generated_clock -divide_by 1  -name clk_sys8 -source [get_ports {pad_xtal0_spad}]      -master_clock clk_32k   [get_pins ${clk_sys_net}] -add
...
create_generated_clock -divide_by 1  -name clk_adc1 -source [get_pins analog_top/RING32M_CLK] -master_clock clk_rc32m [get_pins ${clk_adc_net}]
...
create_generated_clock -divide_by 1  -name clk_ls1 -source [get_pins analog_top/RING32K_CLK]  -master_clock clk_rc32m [get_pins ${clk_ls_net}]
create_generated_clock -divide_by 1  -name clk_ls2 -source [get_ports {pad_xtal0_spad}]       -master_clock clk_32k   [get_pins ${clk_ls_net}] -add
set_clock_group -physically_exclusive -group clk_ls1 -group clk_ls2


#set clk_rc32m_n_net peripherals_i/apb_scu/cmu_u0/xxx
#set clk_rc32k_n_net peripherals_i/apb_scu/cmu_u0/xxx
#set clk_32k_n_net   peripherals_i/apb_scu/cmu_u0/xxx



#create_generated_clock  -invert -name clk_rc32m_n -source [get_pins analog_top/RING32M_CLK] -master_clock clk_rc32m [get_pins ${clk_rc32m_n_net}]
#create_generated_clock  -invert -name clk_rc32k_n -source [get_pins analog_top/RING32K_CLK] -master_clock clk_rc32k [get_pins ${clk_rc32k_n_net}]
#create_generated_clock  -invert -name clk_16m_n   -source [get_pins ${clk_div2_net}]        -master_clock clk_16m   [get_pins ${clk_16m_n_net}]
#create_generated_clock  -invert -name clk_8m_n    -source [get_pins ${clk_div4_net}]        -master_clock clk_8m    [get_pins ${clk_8m_n_net}]
#create_generated_clock  -invert -name clk_4m_n    -source [get_pins ${clk_div8_net}]        -master_clock clk_4m    [get_pins ${clk_4m_n_net}]
#create_generated_clock  -invert -name clk_2m_n    -source [get_pins ${clk_div16_net}]       -master_clock clk_2m    [get_pins ${clk_2m_n_net}]
#create_generated_clock  -invert -name clk_1m_n    -source [get_pins ${clk_div32_net}]       -master_clock clk_1m    [get_pins ${clk_1m_n_net}]
#create_generated_clock  -invert -name clk_32k_n   -source [get_ports {pad_xtal0_spad}]      -master_clock clk_32k   [get_pins ${clk_32k_n_net}]
