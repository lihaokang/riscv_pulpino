...
set_property -dict [list CONFIG.INTERFACE_SELECTION {Disable_AXI} CONFIG.USE_DYN_RECONFIG {false} CONFIG.PRIM_IN_FREQ {100.000} CONFIG.PRIMARY_PORT {clk100_i} CONFIG.CLK_OUT1_PORT {clk_o} CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {32.000} CONFIG.LOCKED_PORT {rst_no} CONFIG.RESET_TYPE {ACTIVE_LOW} CONFIG.RESET_PORT {rst_ni}] [get_ips xilinx_clock_manager]
