            ...
            default://接收成功
              ...
              else
              {
                ...
                else//文件信息保存完之后开始接收数据
                {
                  ...
                  for (j = 0;(j < packet_length) && (FlashDestination <  (uint32_t)ApplicationAddress + size);j += 4)
                  {
