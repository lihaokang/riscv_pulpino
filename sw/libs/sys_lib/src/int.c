...
// 25: timer 1 
__attribute__ ((weak))
void ISR_TIMER1(void){ ICP = (0x1<<25); }

// 26: timer 2 
__attribute__ ((weak))
void ISR_TIMER2(void){ ICP = (0x1<<26); }

// 27: timer 3 
__attribute__ ((weak))
void ISR_TIMER3(void){ ICP = (0x1<<27); }

// 28: timer 4 
__attribute__ ((weak))
void ISR_TIMER4(void){ ICP = (0x1<<28); }

// 29: timer 5 
__attribute__ ((weak))
void ISR_TIMER5(void){ for(;;){} }

// 30: timer 6 
__attribute__ ((weak))
void ISR_TIMER6(void){ for(;;){} }

// 31: timer 7 
__attribute__ ((weak))
void ISR_TIMER7(void){ for(;;){} }

__attribute__ ((weak))
void gen_isr(int isr_num){ ICP = (0x1<<isr_num); }

__attribute__ ((weak))
void TIMER_CMP_INT(void){ for(;;){} }

__attribute__ ((weak))
void vPortFreeRTOSInterruptWrapper(void){ for(;;){} }
