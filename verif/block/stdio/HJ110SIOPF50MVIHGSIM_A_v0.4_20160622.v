...
module IDIO_HJ110SIOPF50MVIHGSIM_A(DIN, DOUT, SPAD, ENO, ENI, OD, PU1, PU2, VCC, VDD, GND);
input DOUT,
      ENO, 
      ENI,
      OD,
...
buf buf1 (WIRE_DIN_IN, SPAD && ENI);//ENI=1, DIN=SPA, DENI=0, DIN=0
bufif1 (SPAD, DOUT, ENO && (! OD) );  //OD=0, ENO=1
bufif1 (SPAD, 0, ENO && OD && (!DOUT) );  //OD=1, ENO=1, DOUT=0
...
module IRSTB_HJ110SIOPF50MVIHGSIM_A(DIN, SPAD, VCC, VDD, GND);
inout SPAD;
output DIN;
wire SPAD, DIN;
inout VCC, VDD, GND;
