...
vlog -quiet -sv -work ${LIB_PATH} ${RTL_PATH}/components/sp_ram_bank_16KB.sv +incdir+/home/share/soc/flow/memlib/sp_ram_4096x32/SHAA110_4096X8X4CM8 || goto error
vlog -quiet -sv -work ${LIB_PATH} ${RTL_PATH}/components/sp_ram_bank_32KB.sv +incdir+/home/share/soc/flow/memlib/sp_ram_8192x32/SHAA110_8192X8X4CM8 || goto error
